...
export default function EntertainmentCard(props) {
    ...
    let intertainment1 = props.intertainment.image
    let image = <img src={intertainment1} className="cafe" alt="card" />
                    ...
                    <MDBCol style={{ maxWidth: "40rem" }}>
                        <MDBCard reverse>
                            ...
                            <MDBCardBody cascade className="text-center">
                                <MDBCardTitle>{props.intertainment.name}</MDBCardTitle>
